          ...
          <span key="Expiry"></span>
                      ...
                      <div className="categories">
                        ...
                        <div className="category">
                          ...
                          <div className="category-item">
                            <p className="label">Reorder Level</p>
                            <p className="value">{selectedProduct.reorderLevel}</p>
                          </div>
                        </div>
                        ...
                        <div className="category">
                          <div className="category-item">
                            <p className="label">Brands/Manufacturer</p>
                            <p className="value">{selectedProduct.brand?.brandName}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Barcode</p>
                            <p className="value">{selectedProduct.itemBarcode}</p>
                            {/* <p className="value">EAN - 1234 5678 9090</p> */}
                          </div>
                          <div className="category-item">
                            <p className="label">Initial Stock Quantity</p>
                            <p className="value">{selectedProduct.initialStock}</p>
                          </div>
                        </div>
                        ...
                        <div className="category">
                          <div className="category-item">
                            <p className="label">Product Type</p>
                            <p className="value">{selectedProduct.itemType}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Warehouse Location</p>
                            <p className="value">{selectedProduct.warehouse}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Track by</p>
                            <p className="value">Serial No.</p>
                        ...
                        <div className="category">
                          <div className="category-item">
                            <p className="label">Supplier</p>
                            <p className="value">{selectedProduct.supplierName || '-'}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Warehouse</p>
                            <p className="value">{selectedProduct.warehouseName || '-'}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Lead Time</p>
                            <p className="value">{selectedProduct.leadTime}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Status</p>
                            <p className="value">{selectedProduct.trackType}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="section-container">
                      ...
                      <div className="section-header">
                        <div className="section-title">
                          ...
                          <div>
                            <p className="section-title-text">{selectedProduct.productName}</p>
                            <p className="section-subtitle">
                              SKU-{selectedProduct.sku} • Available Qty -{" "}
                              {selectedProduct.quantity} {selectedProduct.unit}   
                            </p>
                      ...
                      <div className="categories">
                        ...
                        <div className="category">
                          <div className="category-item">
                            <p className="label">Purchase Price</p>
                            <p className="value">{selectedProduct.purchasePrice}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Unit</p>
                            <p className="value">{selectedProduct.unit}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">HSN / SAC</p>
                            <p className="value">{selectedProduct.hsnCode || '-'}</p>
                          </div>
                        </div>
                        ...
                        <div className="category">
                          <div className="category-item">
                            <p className="label">Selling price</p>
                            <p className="value">{selectedProduct.sellingPrice}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Discount</p>
                            <p className="value">{selectedProduct.discountValue}</p>
                            {/* <p className="value">EAN - 1234 5678 9090</p> */}
                          </div>
                          <div className="category-item">
                            <p className="label">GST Rate</p>
                            <p className="value">{selectedProduct.tax}</p>
                          </div>
                        </div>
                        ...
                        <div className="category">
                          <div className="category-item">
                            <p className="label">Wholesale Price / Bulk Price</p>
                            <p className="value">{selectedProduct.wholesalePrice}</p>
                          </div>
                          <div className="category-item">
                            <p className="label">Discount Period</p>
                            {/* <p className="value">{product.purchasePrice}</p> */}
                        ...
                        <div className="category">
                          <div className="category-item">
                            <p className="label">Quantity</p>
                            <p className="value"> {selectedProduct.quantity}</p>
                          </div>
                        ...
                        <div className="media-content">
                          ...
                          <div>
                            <div className="seo-content">
                              <div>
                                <p className="label">SEO META TITLE</p>
                                <p className="value">{selectedProduct.seoTitle}</p>
                              </div>
                              <div>
                                <p className="label">SEO META Description</p>
                                <p className="value">{selectedProduct.seoDescription}</p>
                              </div>
                            </div>
                            <div>
                              <p className="label">Description</p>
