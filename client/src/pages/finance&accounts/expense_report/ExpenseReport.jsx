...
const [selectedExpense, setSelectedExpense] = useState(null); 
  ...
  return (
    <div style={{ backgroundColor: "white", border: "1px solid #E6E6E6" }}>
      ...
      >
        <span style={{ fontFamily: '"Roboto", sans-serif', fontWeight: "500", color: "#262626", fontSize: "18px" }}>
          Expense Report
        </span>
        <div style={{ display: "flex", gap: "10px" }}>
          <button
      ...
      <div className="d-flex justify-content-between align-items-center" style={{ padding: "15px 20px" }}>
        <div style={{ fontFamily: '"Roboto", sans-serif', fontWeight: "400", fontSize: "16px" }}>
          <button onClick={() => { setFilterStatus("All"); setCurrentPage(1); }} style={{ border: "none", backgroundColor: filterStatus === "All" ? "#E6E6E6" : "white", color: "#262626", padding: "3px 7px" }}>All</button>
          <button onClick={() => { setFilterStatus("Pending"); setCurrentPage(1); }} style={{ border: "none", backgroundColor: filterStatus === "Pending" ? "#E6E6E6" : "white", color: "#262626", padding: "3px 7px" }}>Pending</button>
          <button onClick={() => { setFilterStatus("Paid"); setCurrentPage(1); }} style={{ border: "none", backgroundColor: filterStatus === "Paid" ? "#E6E6E6" : "white", color: "#262626", padding: "3px 7px" }}>Paid</button>
        </div>
        ...
        <div style={{ position: "relative", fontFamily: "Arial" }}>
          ...
          {showCalendar && (
            <div style={{ position: "absolute", zIndex: 999, marginTop: "10px", right: "50px", display: "flex", justifyContent: "center", flexDirection: "column" }}>
              <Calendar
  ...
  <TiEdit
    ...
    />
      ...
      <div className="d-flex justify-content-end gap-3" style={{ padding: "10px 20px" }}>
        ...
        >
          {indexOfFirst + 1}-{Math.min(indexOfLast, expenses.length)}{" "}<span style={{ color: "grey" }}>of {expenses.length}</span>{" "}
          <button onClick={handlePrev} disabled={currentPage === 1} style={{
            border: "none", color: "grey", backgroundColor: "white", cursor: currentPage === 1 ? "not-allowed" : "pointer",
            color: currentPage === 1 ? "grey" : "black",
          }}>
            <GrFormPrevious />
          </button>{" "}
          <button onClick={handleNext} disabled={currentPage === totalPages} style={{
            border: "none", backgroundColor: "white", cursor: currentPage === totalPages ? "not-allowed" : "pointer",
